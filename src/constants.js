...
export const MAX_QUEUE_WAIT_MS = 2_000;
...
export const HTTP_RATE_LIMIT_REQUESTS = 600;
export const HTTP_TOOL_RATE_LIMIT_REQUESTS = 120;
export const HTTP_RATE_LIMIT_WINDOW_MS = 60_000;
export const HTTP_MAX_IN_FLIGHT_TOOL_CALLS = 8;
